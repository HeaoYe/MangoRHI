...
namespace MangoRHI {
    ...
    public:
        ...
        virtual u32 add_textures(DescriptorStage stage, const STL_IMPL::vector<std::reference_wrapper<const Texture>> &textures) = 0;
        virtual u32 add_input_render_targets(DescriptorStage stage, const STL_IMPL::vector<STL_IMPL::pair<const char *, const Sampler &>> &render_targets) = 0;
