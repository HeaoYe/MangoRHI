...
namespace MangoRHI {
    ...
    define_private_member(STL_IMPL::vector<std::reference_wrapper<const VulkanTexture>>, textures, MANGO_NO_INIT_VAULE)
    ...
    define_private_member(STL_IMPL::vector<std::reference_wrapper<const VulkanRenderTarget>>, render_targets, MANGO_NO_INIT_VAULE)
    define_private_member(STL_IMPL::vector<std::reference_wrapper<const VulkanSampler>>, samplers, MANGO_NO_INIT_VAULE)
